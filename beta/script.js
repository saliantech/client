...
async function updateTicket(event) {
  ...
  try {
    ...
    alert("An error occurred while updating the ticket. Check the console for details.");
  }
}

async function deleteTicket(id) {
  if (!id) {
    alert("Ticket ID is required to delete.");
    return;
  }
  ...
  try {
    ...
    alert("An error occurred while deleting the ticket. Check the console for details.");
  }
}
